...
personal open-source imprint *SHLabs*. The imprint is not a
...
Empiria was designed and implemented by **Kevin Schoenholzer**, a
postdoctoral researcher in the social sciences at Università della
Svizzera italiana (USI), Lugano, Switzerland. The project sits at
the intersection of the author's substantive research interests in
...
released under the author's personal open-source imprint *SHLabs*,
distributed entirely free of charge, with all source code, panel
SVGs, build scripts, and reference patches available under the
GPL-3.0 license. Correspondence and feedback are welcome at the
